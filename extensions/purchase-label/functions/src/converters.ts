...
export const mapDataToSchema = (data: DocumentData, schema: ParamSchema): RequestPayload => {
  return {
    shipment: {
      ...
      shipTo: {
        ...
        addressResidentialIndicator: get(data, schema.shipment.shipTo.addressResidentialIndicator)
      },
      shipFrom: {
        ...
        addressResidentialIndicator: get(data, schema.shipment.shipFrom.addressResidentialIndicator)
      },
      ...
      advancedOptions: {
        ...
        billToCountryCode: get(data, schema.shipment.advancedOptions.billToCountryCode),
        billToParty: get(data, schema.shipment.advancedOptions.billToParty),
        billToPostalCode: get(data, schema.shipment.advancedOptions.billToPostalCode),
        containsAlcohol: get(data, schema.shipment.advancedOptions.containsAlcohol),
        deliveredDutyPaid: get(data, schema.shipment.advancedOptions.deliveredDutyPaid),
        ...
        saturdayDelivery: get(data, schema.shipment.advancedOptions.saturdayDelivery),
        useUpsGroundFreightPricing: get(data, schema.shipment.advancedOptions.useUpsGroundFreightPricing),
        ...
        shipperRelease: get(data, schema.shipment.advancedOptions.shipperRelease),
        collectOnDelivery: {
          paymentType: get(data, schema.shipment.advancedOptions.collectOnDelivery.paymentType),
          paymentAmount: get(data, schema.shipment.advancedOptions.collectOnDelivery.paymentAmount),
        },
      },
